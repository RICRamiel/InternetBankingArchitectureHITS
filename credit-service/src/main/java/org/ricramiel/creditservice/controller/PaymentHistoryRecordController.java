...
public class PaymentHistoryRecordController {
    ...
    private final PaymentHistoryRepositoryService paymentHistoryRepositoryService;

    @GetMapping("/{userId}/find_by_user_id")
    public List<PaymentHistoryRecordDTO> findByUserId(@PathVariable UUID userId){
        return PaymentHistoryRecordMapper.toDtoList(paymentHistoryRepositoryService.getHistoryByUserId(userId));
    }
    ...
    public List<PaymentHistoryRecordDTO> findByCardAccountId(@PathVariable UUID cardAccountId){
        return PaymentHistoryRecordMapper.toDtoList(paymentHistoryRepositoryService.getHistoryByCardAccount(cardAccountId));
    }
}
